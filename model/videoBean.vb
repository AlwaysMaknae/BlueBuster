Public Class videoBean
    ...
    Private _photo As String = "https://s3-us-west-1.amazonaws.com/co-directory-images/boursiquot-georgealdly-4a167317.jpg"
    ...
    'constructor
    Public Sub New(photo As String, title As String, year As String, country As String, language As String, length As Integer, [resume] As String, genre As String, actor As String, director As String, status As Integer)
        _photo = photo
        _title = title
        _year = year
        _country = country
